...
def parse():
    ...
    parser.add_argument('--batch_size',      dest="BATCH_SIZE",      default=400, type=int,       help='Batch size')
    ...
    parser.add_argument('--tensorboard',     dest="TENSORBOARD",     default=0, type=int,        help='Whether to use tensorboard')
